                                    ...
                                    <div>
                                        ...
                                        <div className="w-800px">
                                            ...
                                            <div className="row mb-4">
                                                ...
                                                <div className="col-md-4-goat">
                                                    <input className="form-control form-control-solid font-weight-bold h-auto p-6 rounded-lg font-size-h6" defaultValue={templates.templateIcon} name='templateIcon' onChange={e => handleChange(e, 'StepTemplate')} type="url" placeholder="Template Icon" title="Template Icon" />                                                </div>
                                            </div>
                                            <div className="row mb-4">
                                                <div className="col-md-12-goat">
                                ...
                                {step === "StepButton" && (
                                    ...
                                    <div>
                                        ...
                                        <div className="w-800px">
                                            ...
                                            <div className="row mb-4">
                                                <div className="col-md-12-goat">
                                                    <input className="form-control form-control-solid font-weight-bold h-auto p-6 rounded-lg font-size-h6" value={buttons.buttonName} name="buttonName" onChange={(e) => handleChange(e, 'StepButton')} type="text" placeholder="Button Name" title="Button Name" />
                                                </div>
                                            </div>
                                            <div className="row mb-4">
                                                <div className="col-md-12-goat">
                                                    <input className="form-control form-control-solid font-weight-bold h-auto p-6 rounded-lg font-size-h6" value={buttons.buttonLink} name="buttonLink" onChange={(e) => handleChange(e, 'StepButton')} type="url" placeholder="Button Link" title="Button Link" />
                                                </div>
                                            </div>
                                            <div className="row mb-4">
                                                <div className="col-md-12-goat">
                                                    <textarea className="form-control form-control-solid font-weight-bold h-auto p-6 rounded-lg font-size-h6" value={buttons.buttonDescription} name='buttonDescription' onChange={(e) => handleChange(e, 'StepButton')} maxLength="250" rows="2" placeholder="Button Description" title="Button Description" >
                                                    </textarea>
                                                </div>
                                            </div>
                                            <div className="d-flex justify-content-center align-items-center text-center mt-5">
