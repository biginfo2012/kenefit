                        ...
                        <div className="d-flex flex-column-fluid flex-center text-center">
                            <div className="login-form login-signup">
                                <form className="">
                                    ...
                                    <div className="pb-4">
                                        <h3 className="font-weight-boldest text-dark font-size-h4 display-4">Reset Account
                                        </h3>
                                        <p className="text-muted font-weight-bold font-size-h4">it only takes a few seconds</p>
                                    </div>
                                    <div className="row mb-4">
                                        <div className="col-md-12">
                                            <input className="form-control text-center form-control-solid h-auto p-6 rounded-lg font-size-h6" type="email" placeholder="Enter Your Email" />
                                        </div>
                                    </div>
                                    <div className="row mb-4">
                                        <div className="col-md-12">
                                            <input className="form-control text-center form-control-solid h-auto p-6 rounded-lg font-size-h6" type="text" disabled placeholder="Hey, accountName" />
                                        </div>
                                    </div>
                                    <div className="pb-8">
                                        <Link href="">
                                            <a className="btn btn-primary font-weight-boldest font-size-h6 px-8 py-5 btn-block" type="submit">RESET</a></Link>
                                    </div>
                                    <div className="">
                                        <span className="text-muted font-weight-bold font-size-h6"><Link href={"/account/access"}><a>access
                                            account</a></Link> / <Link href={"/account/request"}><a>request
                                                account</a></Link></span>
                                    </div>
                                </form>
                                <Brand />
